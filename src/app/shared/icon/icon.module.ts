...
export class IconModule {
  ...
  svgImageArray = ['add-advance.svg', 'add-expense.svg', 'add-mileage.svg', 'add-per-diem.svg',
    'arrow-prev.svg', 'arrow-next.svg',
    'add-report.svg', 'add-trip.svg', 'auto_fyle.svg', 'add-to-list.svg', 'attachment.svg',
    'bulk.svg', 'bus.svg', 'bulk-mode.svg',
    'chevron-right.svg', 'create-expense.svg', 'create-mileage.svg', 'create-per-diem.svg',
    'curve.svg', 'comments-zero-state', 'circle.svg', 'card-filled.svg',
    'comments-zero-state', 'circle.svg', 'card-filled.svg', 'close.svg', 'capture.svg', 'camera-pointer-top-left.svg',
    'camera-pointer-top-right.svg', 'camera-pointer-bottom-left.svg', 'camera-pointer-bottom-right.svg',
    ...
    'fy-calendar.svg', 'fy-camera.svg', 'fy-car-mini.svg', 'fy-car.svg', 'fy-card.svg',
    ...
    'fy-receipt-attached.svg', 'fy-receipt-not-attached.svg', 'fy-receipt.svg', 'fy-receipts-new.svg',
    'fy-receipts.svg', 'fy-recently-used.svg', 'fy-rectangle.svg', 'fy-reports-new.svg', 'fy-reports.svg', 'fy-reimbursable.svg',
    ...
    'fy-wallet.svg', 'fy-search.svg', 'fy-clear.svg', 'flag.svg', 'fy-unmatched.svg', 'fy-location.svg',
    'gas.svg', 'gallery.svg',
    'hotel.svg',
    ...
    'software.svg', 'split-expense.svg', 'send.svg', 'send-back.svg', 'success-tick.svg', 'search-not-found.svg', 'single-mode.svg',
