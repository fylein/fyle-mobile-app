...
describe('FySelectProjectComponent', () => {
  ...
  beforeEach(
    waitForAsync(() => {
      ...
      const ngControlSpy = jasmine.createSpyObj('NgControl', ['touched', 'valid']);

      TestBed.configureTestingModule({
        declarations: [FySelectProjectComponent],
        imports: [IonicModule.forRoot(), FormsModule, ReactiveFormsModule, MatIconModule],
        providers: [
          {
