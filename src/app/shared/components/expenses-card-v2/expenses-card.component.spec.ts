...
describe('ExpensesCardComponent', () => {
  ...
  describe('onFileUPload()', () => {
    ...
    it('should show size limit exceeded popover if the file size is more than 15MB', fakeAsync(() => {
      const mockFile = new File(['file contents'], 'test.png', { type: 'image/png' });
      Object.defineProperty(mockFile, 'size', { value: 15728641 });
      const mockNativeElement = {
        files: [mockFile],
      };
  ...
  it('showSizeLimitExceededPopover', fakeAsync(() => {
    ...
    component.showSizeLimitExceededPopover(15728641);
    ...
    expect(popoverController.create).toHaveBeenCalledOnceWith({
      ...
      componentProps: {
        ...
        message: 'The uploaded file is greater than 15MB in size. Please reduce the file size and try again.',
        primaryCta: {
          text: 'OK',
        },
      },
