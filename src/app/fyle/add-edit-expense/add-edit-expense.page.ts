          ...
          this.fg.patchValue(
            {
              project,
              category,
              dateOfSpend: etxn.tx.txn_dt && dayjs(etxn.tx.txn_dt).format('y-MM-DD'),
              ...
              from_dt: etxn.tx.from_dt && dayjs(etxn.tx.from_dt).format('y-MM-DD'),
              to_dt: etxn.tx.to_dt && dayjs(etxn.tx.to_dt).format('y-MM-DD'),
                ...
                this.formBuilder.group({
                  ...
                  value: [
                    customField.type !== 'DATE'
                      ? customField.value
                      : customField.value && dayjs(customField.value).format('y-MM-DD'),
    ...
    orgSettings$
      ...
      .subscribe(({ etxn, splitExpenses }) => {
        ...
        forkJoin({
          ...
          const txnDt = dayjs(this.selectedCCCTransaction.txn_dt).format('MMM d, y');
