...
@Component({
  ...
  templateUrl: './add-expenses-to-report-v2.component.html',
  styleUrls: ['./add-expenses-to-report-v2.component.scss'],
})
export class AddExpensesToReportV2Component implements OnInit {
