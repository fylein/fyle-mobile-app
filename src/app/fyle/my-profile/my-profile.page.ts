...
export class MyProfilePage {
  ...
  settingsMap: {
    ...
    // defaultCurrency: 'preferred_currency', // Doubt if this is needed
  ...
  toggleSetting(eventData: EventData): Subscription {
    ...
    if (eventData.key === 'defaultCurrency' && eventData.isEnabled && eventData.selectedCurrency) {
      // this.employeeSettings.preferred_currency = eventData.selectedCurrency.shortCode || null; -- Doubt if this is needed
    }
  ...
  setPreferenceSettings(): void {
    const allPreferenceSettings: PreferenceSetting[] = [
      ...
      },
      {
        ...
        key: 'defaultCurrency',
        // defaultCurrency: this.employeeSettings.preferred_currency, - Doubt if this is needed
        // isEnabled: this.employeeSettings.enabled, - Doubt if this is needed
