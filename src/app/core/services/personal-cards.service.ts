...
export class PersonalCardsService {
  ...
  private generateUpdatedOnCustomDatePill(filters: any, filterPills: FilterPill[]) {
    const startDate = filters.updatedOn.customDateStart && dayjs(filters.updatedOn.customDateStart).format('y-MM-D');
    const endDate = filters.updatedOn.customDateEnd && dayjs(filters.updatedOn.customDateEnd).format('y-MM-D');
  ...
  private generateCreatedOnCustomDatePill(filters: any, filterPills: FilterPill[]) {
    const startDate = filters.createdOn.customDateStart && dayjs(filters.createdOn.customDateStart).format('y-MM-D');
    const endDate = filters.createdOn.customDateEnd && dayjs(filters.createdOn.customDateEnd).format('y-MM-D');
