...
export class DataTransformService {
  ...
  transformOrgUser(platformRes: EmployeeResponse): OrgUser {
    return {
      id: platformRes.id,
  ...
  transformEmployeeResponse(platformRes: EmployeeResponse): ExtendedOrgUser {
    const transformedResponse: ExtendedOrgUser = {
      ou: this.transformOrgUser(platformRes),
      org: {
        currency: platformRes.currency,
      },
      us: {
      ...
      mileage_settings: platformRes.mileage_settings,
    };
