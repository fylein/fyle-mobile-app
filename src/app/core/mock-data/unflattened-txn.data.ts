...
export const expWithCriticalViolation: { etxn: UnflattenedTransaction; comment: string } = deepFreeze({
  etxn: {
    tx: {
      ...
      receipt_required: false,
      user_can_delete: true,
      spent_at: new Date('2023-05-30T01:00:00.000Z'),
      category: null,
      amount: 780,
      user_amount: 780,
      policy_amount: null,
...
export const expectedExpenseObservable: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    skip_reimbursement: false,
    source: 'MOBILE',
    spent_at: new Date('2023-01-17T06:34:32.50466Z'),
    currency: 'USD',
    amount: 100,
    orig_currency: null,
    orig_amount: null,
...
export const expectedExpenseObservable2 = deepFreeze({
  tx: {
    skip_reimbursement: false,
    source: 'MOBILE',
    spent_at: new Date('2019-06-19T01:00:00.000Z'),
    currency: 'ARS',
    amount: null,
    orig_currency: null,
    orig_amount: null,
...
export const expectedExpenseObservable5: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    ...
    num_files: 1,
    org_user_id: 'ouX8dwsbLCLv',
    spent_at: new Date('2023-01-24T17:00:00.000Z'),
    category_id: undefined,
    fyle_category: undefined,
    extracted_data: {
      amount: 100,
...
export const unflattenedExpWithCCCExpn: UnflattenedTransaction = deepFreeze({
  ...
  tx: {
    ...
    spent_at: new Date('2021-07-29T06:30:00.000Z'),
    user_amount: 100,
    policy_amount: 0,
    currency: 'USD',
    state: 'DRAFT',
...
export const newExpFromFg: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    ...
    receipt_required: false,
    user_can_delete: true,
    spent_at: new Date('2019-06-19T06:30:00.000Z'),
    category: null,
    amount: 500,
    user_amount: 780,
    policy_amount: null,
...
export const newExpFromFgPlatform: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    ...
    spent_at: new Date('2024-02-08T18:30:00.000Z'),
...
export const newExpenseMileageData1: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    ...
    source: 'MOBILE',
    state: 'COMPLETE',
    spent_at: new Date('2023-08-21T07:43:15.592Z'),
    category_id: 141295,
...
export const newMileageExpFromForm: Partial<UnflattenedTransaction> = deepFreeze({
  tx: {
    ...
    cost_center_code: null,
    cost_center_id: 2411,
    spent_at: new Date('2023-02-13T01:00:00.000Z'),
    ...
    custom_properties: [
      ...
      },
      {
        ...
        prefix: '',
        type: 'DATE',
        value: new Date('2023-02-13T01:00:00.000Z'),
      },
    ],
    is_implicit_merge_blocked: false,
    categoryDisplayName: 'Software',
