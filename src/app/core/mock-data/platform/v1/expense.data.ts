  ...
  custom_fields: [
    {
      name: 'test - mult',
      value: ['b', 'c'],
      type: CustomFieldTypes.MULTI_SELECT,
      is_enabled: true,
    },
  ],
...
export const perDiemExpense: Expense = {
  ...
  custom_fields: [
    ...
    },
    {
      ...
      value: '',
      type: CustomFieldTypes.DEPENDENT_SELECT,
      is_enabled: false,
    },
    {
    ...
    custom_fields: [
      {
        is_enabled: true,
        name: 'userlist',
        type: CustomFieldTypes.USER_LIST,
        value: null,
      },
      {
        is_enabled: true,
      ...
      },
      {
        is_enabled: true,
        name: 'test 112',
        type: CustomFieldTypes.LOCATION,
        value: null,
      },
      {
        is_enabled: true,
...
export const apiExpenses2: Expense[] = [
  {
    accounting_export_summary: {},
...
export const splitExpensesData: Expense[] = [
  {
    ...
    employee: {
      ...
      mobile: null,
      org_id: 'oroLKHBYQVvj',
      org_name: 'CC Transaction Testing',
      title: null,
      user: {
    ...
    spent_at: new Date('2024-01-31T06:30:00.000Z'),
    split_group_amount: 12,
...
export const apiExpenses3: Expense[] = [
  {
    ...
    source_account_id: 'acc7F6bwRa52p',
    spent_at: new Date('2024-01-31T11:30:00.000Z'),
    split_group_amount: 12,
    split_group_id: 'tx6I9xcOZFU6',
    started_at: null,
    state: ExpenseState.COMPLETE,
...
export const platformExpenseWithExtractedData: Expense = {
  ...
  cost_center: null,
  cost_center_id: null,
  created_at: new Date('2024-02-11T22:57:43.416Z'),
  creator_user_id: 'usvMoPfCC9Xw',
  currency: 'USD',
  custom_fields: [
    {
  ...
  file_ids: ['fijiKmWjhy3Y'],
  files: [
    {
      content_type: 'application/pdf',
      id: 'fijiKmWjhy3Y',
      name: 'Jan_Food_Swiggy1.pdf',
      type: FileType.RECEIPT,
    },
  ],
  foreign_amount: 219.66,
  ...
  source_account_id: 'accO6abI7gZ6T',
  spent_at: new Date('2024-01-19T11:30:00.000Z'),
  split_group_amount: null,
...
export const platformExpenseWithMatchCCC: Expense = {
  ...
  cost_center: null,
  cost_center_id: null,
  created_at: new Date('2024-01-23T06:49:49.370Z'),
  creator_user_id: 'SYSTEM_CORPORATE_CARD',
  currency: 'USD',
  custom_fields: [],
  custom_fields_flattened: {},
  distance: null,
  ...
  last_verified_at: null,
  locations: [],
  matched_corporate_card_transaction_ids: ['btxnSte7sVQCM8'],
  matched_corporate_card_transactions: [
    {
      amount: 260.37,
      bank_name: 'DSR',
      ...
      corporate_card_number: '7620',
      corporate_card_user_full_name: 'Devendra Singh Rana',
      currency: 'USD',
      description: null,
      foreign_amount: null,
      foreign_currency: null,
      id: 'btxnSte7sVQCM8',
      masked_corporate_card_number: '7620',
      matched_by: null,
