...
export const unflattenedAccount3Data = deepFreeze({
  ...
  org: { id: 'orrb8EW1zZsy', domain: 'fyle.in' },
  advance: {
    id: 'adve6o3JdrDbI',
    purpose: 'erertert',
    number: 'A/2022/03/T/4',
  },
  orig: { currency: 'USD', amount: 23213 },
  currency: 'USD',
  amount: 23213,
  id: 'acc6mK6CEesGL',
  type: AccountType.ADVANCE,
...
export const paymentModeDataPersonal = deepFreeze({
  ...
  org: { id: 'orNVthTo2Zyo', domain: 'fyle.in' },
  advance: {
    id: null,
    purpose: null,
    number: null,
  },
  orig: { currency: 'INR', amount: 0 },
  currency: 'INR',
  amount: 0,
  id: 'accZ1IWjhjLyu4',
  type: AccountType.PERSONAL,
...
export const paymentModeDataAdvance = deepFreeze({
  ...
  org: { id: 'orrb8EW1zZsy', domain: '' },
  advance: {
    id: 'adve6o3JdrDbI',
    purpose: 'erertert',
    number: 'A/2022/03/T/4',
  },
  orig: { currency: 'USD', amount: 223146436 },
  currency: 'USD',
  amount: 223146436,
  id: 'acc6mK6CEesGL',
  type: AccountType.ADVANCE,
...
export const multiplePaymentModesWithoutAdvData: ExtendedAccount[] = deepFreeze([
  {
    acc: {
      ...
      displayName: 'Corporate Card',
      isReimbursable: false,
      created_at: new Date('2018-08-05T08:32:51.583+05:30'),
      updated_at: new Date('2022-12-13T13:24:33.814+05:30'),
      name: 'Corporate Credit Card Account',
      category: '',
    },
    advance: { id: null, purpose: null, number: null },
    amount: 0,
    balance_amount: 0,
    ...
    id: 'accsHcKgVeCZW',
    isReimbursable: false,
    org: { id: 'orYZOyDOk4iL', domain: '' },
    org_id: 'orYZOyDOk4iL',
    orig: { currency: 'USD', amount: 0 },
    type: AccountType.CCC,
...
export const multiplePaymentModesWithCompanyAccData2: ExtendedAccount[] = deepFreeze([
  {
    acc: {
      id: 'accYoo40xd0C1',
      created_at: new Date('2018-08-05T08:32:51.583+05:30'),
  ...
  },
  {
    acc: {
      id: 'accYoo40xd0C1',
      created_at: new Date('2018-08-05T11:32:11.742+05:30'),
      updated_at: new Date('2022-12-09T15:46:22.082+05:30'),
      name: 'Personal Account',
      type: AccountType.PERSONAL,
      currency: 'USD',
      current_balance_amount: 0,
...
export const paymentModesWithAdvanceWalletsResData = deepFreeze([
  {
    ...
    value: {
      acc: {
        id: 'accYoo40xd0C1',
        created_at: new Date('2018-08-05T14:02:51.583+05:30'),
        updated_at: new Date('2022-12-23T14:04:46.658+05:30'),
        name: 'Corporate Credit Card Account',
        type: AccountType.CCC,
        currency: 'USD',
  ...
  },
  {
    ...
    value: {
      acc: {
        id: 'accWUsrRlinFb',
        created_at: new Date('2018-08-05T11:32:11.742+05:30'),
        updated_at: new Date('2022-12-23T14:02:19.246+05:30'),
        name: 'Personal Account',
        type: AccountType.PERSONAL,
        currency: 'USD',
        current_balance_amount: 0,
