...
export const unflattenedTransactionPersonal: UnflattenedTransaction = deepFreeze({
  tx: {
    ...
    spent_at: new Date('2018-06-25T04:30:00.000Z'),
    category: null,
    amount: 141.96,
    user_amount: 141.96,
    policy_amount: null,
...
export const multiplePaymentModesWithCompanyAccData3: PlatformAccount[] = deepFreeze([
  {
    id: 'accsHcKgVeCZW',
    created_at: '2018-08-05T08:32:51.583+05:30',
    updated_at: '2022-12-13T13:24:33.814+05:30',
...
export const etxnObjData = deepFreeze({
  tx: {
    skip_reimbursement: false,
    source: 'MOBILE',
    spent_at: new Date('2022-12-20T20:41:40.771Z'),
    currency: 'USD',
    amount: null,
    orig_currency: null,
    orig_amount: null,
...
// New test data that represents what the service actually returns
export const multiplePaymentModesWithPersonalAndCompanyData: PlatformAccount[] = deepFreeze([
  {
    id: 'accWUsrRlinFb',
    created_at: '2018-08-05T06:02:11.742Z',
    updated_at: '2022-12-09T10:16:22.082Z',
